...
public class CustomerProfileWindow {
    ...
    public void show() {
        ...
        // Title
        Label titleLabel = new Label("Update Your Profile");
        ...
        TextField nameField = createStyledTextField(customer.getFullName());
        TextField emailField = createStyledTextField(customer.getEmail());
        TextField phoneField = createStyledTextField(customer.getPhone());
        TextField addressField = createStyledTextField(customer.getAddress());
        TextField usernameField = createStyledTextField(customer.getUsername());
        PasswordField passwordField = createStyledPasswordField();
        PasswordField confirmPasswordField = createStyledPasswordField();

        // Create save button
        Button saveButton = createStyledButton("Save Changes", "#4CAF50", 16);
        ...
        saveButton.setOnAction(e -> {
            try {
                ...
                // Save changes
                if (new CustomerDAO().updateCustomer(customer)) {
